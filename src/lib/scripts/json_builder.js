...
const quotesArray = [
    ...
    {
        quoteText: "I think it shows that law, even when it looks like a simple legal task, always contains hidden complexity.",
        media: "2025_03_17_AUDIO",
    ...
    {
        quoteText: "I think I tend to do quite detailed prompts because I want the LLM to be effective. I really put a lot of information in it. When we did the first experiments with this group, I asked more general questions and I got a lot of hallucinations with ChatGPT.",
        media: "",
        filename: "",
        timestamp: ""
    },
    ...
    {
        quoteText: "I didn't have the tools to understand the breakdown, and so I couldn't solve the problem",
        media: "",
        filename: "",
        timestamp: ""
    },
    ...
    {
        quoteText: "when the result is too general, and I don't know enough about the subject to ask more precise questions, I feel like I'm at a dead end, because I can't choose a new path of questions.",
        media: "",
        filename: "",
        timestamp: ""
    },
    {
        quoteText: "while it is difficult to determine whether it actually improves the outputs [...], it leads me to believe I put sufficient effort in maxing out the LLM",
        media: "",
        filename: "",
        timestamp: ""
    },
    {
        quoteText: "I thought I could kind of adjust how it worked. But in the end, I found that the more I tried to get a precise formulation, the more random the results became. I had this experience while trying to get it to use one specific word, 'populism', and the more I pushed for that, the weirder the answers got. I had no way of knowing how to influence the outcome. So it gave me this kind of feeling of absurdity, which was surprising, because I actually expected the opposite by the end of the experiments.",
        media: "2025_03_17_AUDIO",
        filename: "could_kind_of.mp4",
        timestamp: "01:39:05:25 - 01:39:46:11"
    },
    {
        quoteText: "There's this moment when I realize, after giving multiple instructions, clarifying, or rephrasing, that ChatGPT is giving me completely off-topic information. I end up feeling really frustrated and give up, out of lack of time and motivation. [...] ChatGPT just doesn't understand what I asked, despite all my efforts",
        media: "",
        filename: "",
        timestamp: ""
    },
    ...
    {
        quoteText: "I think I distrust the machine more, and maybe I'm just biased, because it's probabilistic—I really don't think it understands. But if it's a colleague or an intern, that person can still learn, and you can actually teach them how to do it",
        media: "2025_03_17_AUDIO",
    ...
    {
        quoteText: "I think throughout all the practice, I really found myself gravitating toward some boring tasks—like we all did. Things I don't really enjoy, and that often take up way too much time, things I don't actually want to spend time on. For me, that's usually paraphrasing.",
        media: "2025_03_17_AUDIO",
        filename: "myself_gravitating.mp4",
        timestamp: "00:52:26:04 - 00:52:43:02"
    },
    {
        quoteText: "A large part of our time as economists is spent on really uninteresting tasks. That's probably why economists have so many research assistants [laughter]. And also, the profession is relying more and more on heavy tools that require tons of annotation, data cleaning, and all that. Which means less time for more theoretical or analytical tasks. So, in theory, LLMs could help gain time for that. But in practice, I don't think that's what's happening.  Because now that we can do more complex things with machines, we end up pushing the tools even further. And in the end, I don't think we actually spend more time trying to really understand the mechanisms at stake. We just want a fancy method that will impress people. [...] So it's true, it expands possibilities a lot for economists. But is that really what we should be doing? I don't know. Maybe it's not where our discipline is the most valuable",
        media: "2025_03_17_AUDIO",
    ...
    {
        quoteText: "I have a very short deadline, like a month and a half, and I'm super, super late for work. [...] I'm trying not to let the time pressure get to me. I tell myself, 'No, I'll take the time I need, even if it means some parts are less developed.' I'm trying not to be a perfectionist, trying not to do everything all at once",
        media: "2025_03_17_AUDIO",
        filename: "short_deadline.mp4",
        timestamp: "01:43:06:17 - 01:44:04:18"
    },
    {
        quoteText: "So you're trying to set boundaries for your work, based on what you as a human are capable of doing?",
        media: "2025_03_17_AUDIO",
        filename: "boundaries_for_your_work.mp4",
        timestamp: "01:44:04:18 - 01:44:11:16"
    },
    {
        quoteText: "Yeah, boundaries for my work, for my topic, and also for which tasks I do myself and which ones I might do with ChatGPT. But it's a slippery slope. Initially, I didn't want to use it at all. However, I then got stuck on some sociological concepts, and my advisor couldn't help, so I asked GPT. And because it worked, I used it to look for literature. Since that worked, I would like to use it for a literature review. And I'm trying not to. But because it works, it's hard not to. Still, I don't want to be productive just for the sake of productivity. I just want to do good work",
        media: "2025_03_17_AUDIO",
